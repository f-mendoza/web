...
class DBManager{
  function DBManager($host,$user,$pass,$db){
    ...
    if($mysqli->connect_errno){
      ...
      if (!$mysqli->query("CREATE TABLE IF NOT EXISTS USUARIOS(ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT, USERNAME VARCHAR(30) NOT NULL, PERSON INT NOT NULL, MAINEMAIL INT NOT NULL, FOREIGN KEY(PERSON) REFERENCES PERSONS(ID), FOREIGN KEY(MAINEMAIL) REFERENCES MAILS(ID))")){
        echo "ERROR (".$mysqli->error.")";
      }
